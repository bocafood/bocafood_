...
function buildEmailLayout(settings, template, variables) {
  ...
  const ctaHtml = ctaLabel && ctaUrl
    ? `<div style="margin-top:20px;text-align:left;"><a href="${escapeHtml(ctaUrl)}" style="display:inline-block;background:linear-gradient(135deg,#C4362A 0%,#A92F25 100%);color:#ffffff;text-decoration:none;border-radius:12px;padding:0 19px;height:44px;line-height:44px;font-size:14px;font-weight:700;min-width:158px;text-align:center;border:1px solid rgba(126,31,24,.16);box-shadow:0 10px 20px rgba(196,54,42,.14),inset 0 1px 0 rgba(255,255,255,.20);">${escapeHtml(ctaLabel)}</a></div>`
    : "";
