    ...
    if (key === 'configuracoes-usuario') {
      ...
      body = '<div class="help-guide-panel-head">' +
        ...
        _guideFields([
          ...
          ['Custo atual', 'Esse campo é atualizado automaticamente pelo BocaFood quando você registra compras. Ele mostra o custo mais recente encontrado para o item e serve como referência para receitas, margens e decisões de compra.'],
