  ...
  function _checklistGuideForStep(step, phase) {
    ...
    var guides = {
      ...
      'Cadastrar receitas': {
        ...
        fields: [
          ['Nome da receita', 'Coloque o nome da receita principal que você está cadastrando. Exemplos: Coxinha, Brigadeiro, Bolo de Pote ou Molho Especial. As partes da receita, como massa, recheio e finalização, entram depois em Etapa da receita.'],
          ['Categoria', 'Agrupe receitas principais parecidas para encontrar mais rápido depois. Exemplos: Salgados, Doces, Bolos, Bebidas, Molhos ou Pratos prontos. Massa, recheio e finalização devem ficar em Etapa da receita, não como categoria principal.'],
