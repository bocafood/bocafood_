...
Modules.Dashboard = (function () {
    ...
    app.innerHTML = '' +
      '<div class="module-page dash-root" style="padding:24px;display:flex;flex-direction:column;gap:18px;">' +
        '<style>' +
          ...
          '.dash-onboarding-pill{position:fixed;right:22px;bottom:92px;z-index:80;box-shadow:0 14px 30px rgba(31,31,31,.16);}' +
          ...
          '@media(max-width:760px){.dash-onboarding-float{right:12px;bottom:12px;width:calc(100vw - 24px);}.dash-onboarding-pill{right:12px;bottom:calc(92px + env(safe-area-inset-bottom,0px));}.dash-tour-backdrop,.dash-welcome-backdrop{align-items:flex-end;padding:12px;}.dash-tour-modal,.dash-welcome-modal{border-radius:22px;max-height:calc(100dvh - 24px);overflow:auto;}}' +
        '</style>' +
  ...
  function _ensureGlobalOnboardingStyles() {
    ...
    style.textContent =
      ...
      '@media(max-width:760px){.dash-onboarding-float{right:12px;bottom:12px;width:calc(100vw - 24px);}.dash-onboarding-pill{right:12px;bottom:calc(92px + env(safe-area-inset-bottom,0px));}.dash-tour-backdrop,.dash-welcome-backdrop,.dash-checklist-backdrop{align-items:flex-end;padding:12px;}.dash-tour-modal,.dash-welcome-modal{border-radius:22px;max-height:calc(100dvh - 24px);overflow:auto;}.dash-checklist-modal{border-radius:22px;max-height:calc(100dvh - 24px);}.dash-checklist-detail{grid-template-columns:1fr;gap:3px;}}';
  ...
  function _checklistGuideForStep(step, phase) {
    ...
    var guides = {
      ...
      'Cadastrar receitas': {
        ...
        fields: [
          ['Nome da receita', 'Coloque o nome da receita principal que você está cadastrando. Exemplos: Coxinha, Brigadeiro, Bolo de Pote ou Molho Especial.'],
          ['Categoria', 'Agrupe receitas principais parecidas para encontrar mais rápido depois. Exemplos: Salgados, Doces, Bolos, Bebidas, Molhos ou Pratos prontos.'],
          ...
          ['Rendimento', '<strong style="color:#1F1F1F;">Informe quanto a receita pronta rende no final.</strong><br>Preencha a <strong style="color:#1F1F1F;">quantidade final produzida</strong>, não a quantidade de ingredientes usados.<br><br><strong style="color:#1F1F1F;">Exemplos:</strong><br>• Coxinha: <strong style="color:#1F1F1F;">15 unidades</strong><br>• Brigadeiro: <strong style="color:#1F1F1F;">30 unidades</strong><br>• Massa pronta: <strong style="color:#1F1F1F;">2 kg</strong><br>• Molho: <strong style="color:#1F1F1F;">1,5 litro</strong>', true],
          ['Tipo de rendimento', '<strong style="color:#1F1F1F;">Escolha a unidade que combina com o resultado final da receita.</strong><br><br>Use <strong style="color:#1F1F1F;">unidades</strong> para coxinhas, brigadeiros, bolos no pote e itens contáveis.<br>Use <strong style="color:#1F1F1F;">kg</strong> para massas, recheios e preparos pesados.<br>Use <strong style="color:#1F1F1F;">litros</strong> para molhos, caldas, bebidas e líquidos.', true],
          ...
          ['Base de produção', 'Separe a receita em bases como massa, recheio, cobertura ou finalização. Isso deixa a produção mais organizada e ajuda a entender onde cada ingrediente entra.'],
          ['Anotação da base', 'Use para um detalhe específico daquela base dentro da receita. Exemplo: usar fria, bater por mais tempo ou adicionar no final.'],
          ['Controlar como base de produção', 'Marque quando essa base é feita antes e usada depois em outros produtos, como massa, recheio, molho ou creme. Assim ela pode ser acompanhada como produção própria.'],
          ['Rendimento da base', '<strong style="color:#1F1F1F;">Informe quanto aquela base rende depois de pronta.</strong><br><br><strong style="color:#1F1F1F;">Exemplos:</strong><br>• Massa da coxinha: <strong style="color:#1F1F1F;">15 unidades</strong><br>• Recheio da coxinha: <strong style="color:#1F1F1F;">40 unidades</strong><br>• Creme: <strong style="color:#1F1F1F;">1,5 kg</strong><br>• Molho: <strong style="color:#1F1F1F;">2 litros</strong><br><br>Se a base rende igual à receita final, <strong style="color:#1F1F1F;">repita o mesmo número da receita.</strong>', true],
          ['Ingredientes', 'Escolha os ingredientes já cadastrados em Compras > Ingredientes, Embalagens e Produtos. Eles ficam dentro da base da receita, como massa, recheio, cobertura ou finalização.'],
          ['Embalagens da receita', 'Escolha as embalagens separadas das bases. Elas acompanham o rendimento global da receita. Exemplo: se a receita rende 15 unidades e cada unidade usa 1 saquinho, preencha 15 saquinhos. Se toda a receita vai em 1 caixa, preencha 1 caixa.'],
      ...
      'Criar primeira Temporada': {
        ...
        fields: [
          ...
          ['Objetivo', '<strong style="color:#1F1F1F;">Para a primeira Temporada do onboarding, escolha Aumentar Ticket.</strong><br><br>Esse objetivo faz cada pedido valer mais com adicionais, combos ou upsell, sem depender de histórico grande de pedidos.<br><br><strong style="color:#1F1F1F;">Vender Mais</strong>: quando já existe base para buscar mais faturamento, pedidos e dias com venda.<br><strong style="color:#1F1F1F;">Aumentar Ticket</strong>: quando precisa fazer cada pedido valer mais, com adicionais, combos ou upsell.<br><strong style="color:#1F1F1F;">Fidelizar Clientes</strong>: quando quer trazer clientes de volta, usar pontos, cupom de retorno e recompra.<br><strong style="color:#1F1F1F;">Melhorar Consistência</strong>: quando as vendas estão muito concentradas em poucos dias ou horários.', true],
          ...
          ['Estratégia operacional', '<strong style="color:#1F1F1F;">Para essa primeira rodada, use Margem.</strong><br><br>A estratégia Margem protege a sobra e evita começar com ações de volume antes de entender melhor o comportamento real das vendas.<br><br><strong style="color:#1F1F1F;">Volume</strong>: foca em mais pedidos, mais movimento e mais dias com venda.<br><strong style="color:#1F1F1F;">Margem</strong>: foca em vender melhor, proteger a sobra e evitar ações que comem resultado.<br><strong style="color:#1F1F1F;">Fidelização</strong>: foca em clientes que voltam, pontos, cupons de retorno e relacionamento.', true],
        ...
        actions: ['Crie primeiro uma rota ativa no Plano de Voo.', 'Na primeira Temporada, escolha Aumentar Ticket.', 'Escolha uma dificuldade que você consegue cumprir na vida real.', 'Use estratégia Margem para proteger a sobra enquanto ainda há pouco histórico.', 'Revise o resumo final antes de salvar.', 'Depois acompanhe a aba Próxima Jogada para executar as ações da Temporada.'],
    ...
    return [
      ...
      },
      {
        ...
        details: [
          ...
          ['Produto ligado', 'quando a receita vira item vendido ou base de producao.']
        ],
        actionTitle: 'Primeiro passo',
      ...
      },
      {
        ...
        actionTitle: 'Primeiro passo',
        action: 'Depois do Plano de Voo, crie a primeira Temporada com objetivo Aumentar Ticket e estratégia Margem. Como ainda não há histórico, esse início ajuda a vender melhor antes de buscar volume.',
